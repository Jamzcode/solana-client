...
function newAccountWithLamports(connection_1) {
    return __awaiter(this, arguments, void 0, function* (connection, lamports = 1000000) {
        const account = web3_js_1.Keypair.generate();
        let retries = 30;
        yield connection.requestAirdrop(account.publicKey, lamports);
        for (;;) {
            yield (0, sleep_js_1.sleep)(500);
...
//# sourceMappingURL=new-account-with-lamports.js.map